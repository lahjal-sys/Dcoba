...
// ✅ FIX 1: Hapus trailing spaces di URL
...
// ✅ FIX 2: Pastikan cuma 1 initiateBYOP + hapus spasi di URL
export const initiateBYOP = (redirectUrl) => {
  const params = new URLSearchParams({
    redirect_url: redirectUrl,
    models: 'flux,zimage-turbo,kontext,klein',
    permissions: 'profile,balance,generate',
    expiry: '30'
  });
  return `https://enter.pollinations.ai/authorize?${params}`; // ✅ No extra spaces
};
