...
// ✅ SSR-SAFE: Cek dulu apakah kode jalan di browser
export const saveToStorage = (key, value) => {
  if (typeof window === 'undefined') return false; // ❌ Jangan jalan di server
  try {
...
export const loadFromStorage = (key, defaultValue = null) => {
  if (typeof window === 'undefined') return defaultValue; // ❌ Jangan jalan di server
  try {
...
// ... terapkan pola yang sama untuk fungsi lainnya:
// removeFromStorage, saveTheme, loadTheme, saveAPIKey, dll
