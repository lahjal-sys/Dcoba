...
// ✅ Coba 'zimage' tanpa '-turbo'
const MODELS={FLUX:'flux',ZIMAGE:'zimage'};
...
export default function Home(){
  ...
  const generate=async()=>{
    ...
    try{
      ...
      // ✅ HAPUS nologo=true
      const url=`${BASE}/${encodeURIComponent(prompt)}?width=${selR.w}&height=${selR.h}&seed=${seed}&model=${model}${API_KEY?'&key='+API_KEY:''}`;
